...
import static com.v1.planner.enums.Role.*;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(req ->
                        req.requestMatchers("/**")
                                .permitAll()
                                .requestMatchers("/api/**").hasAnyRole(ADMIN.name(), MEMBER.name())
                                .requestMatchers(GET, "/api/**").hasAnyAuthority(ADMIN_READ.name(), MEMBER_READ.name())
